...
import (
	...
	_ "github.com/vineel-pynam/SimpleBank/doc/statik"
	"github.com/vineel-pynam/SimpleBank/gapi"
...
func runGatewayServer(config utils.Config, store db.Store, taskDistributor worker.TaskDistributor) {
	...
	if err != nil {
		log.Fatal().Msg("cannot start HTTP gatway Server")
	}
}
...
func runGinServer(config utils.Config, store db.Store) {
	...
	if err != nil {
		log.Fatal().Msg("cannot connect to the server")
	}
}
